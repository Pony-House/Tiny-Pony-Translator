...
_This will open a local server (usually on port 3000) so you can test the web UI._
...
_Note: You will find your compiled executables inside the `dist` folder._
...
_This will generate a `dist-web` folder in the root directory. Simply upload the contents of this folder to your web server, and your Web App is ready to go!_
